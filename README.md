[index.html.html](https://github.com/user-attachments/files/27235473/index.html.html)
<!DOCTYPE html>
<html lang="ru">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>СТК Расписание</title>
...
<header>
  <h1>СТК Расписание</h1>
</header>

<div class="container">
  <select id="group" onchange="render()"></select>
  <div id="app">Загрузка расписания...</div>
</div>
